...
namespace coba4
{
    public class Kemeja : Pesanan
    {
        ...
        public static double totalWaktu(double jumlahProduksi, double waktuProduksiPerLusin)
        {
            ...
            // durasiAkhir = totalWaktuProduksi;
            return totalWaktuProduksi;
        }

        public void dataPesanan(ref double jumlahHarga, ref double lamaProduksi)
        {
        ...
        public bool mauCepat(double lamaProduksi, ref double jumlahHarga, ref double reqHari)
        {
            ...
            if (ans == "ya")
            {
                ...
                else if(reqHari==lamaProduksi)
                {
                    ...
                    mauCepat(lamaProduksi, ref jumlahHarga, ref reqHari);
                }
                else
                {
